...
**Generated:** 2026-06-30T12:59:04.085056
**Input:** `outputs\k2_jax_dedicated_default_v1`
**input_dir:** outputs\k2_jax_dedicated_default_v1
...
- **Performance:** 150.2 Hz avg (min 90.4, max 198.4)
...
| hip_yaw_joint_max_rad | 0.0861 | 0.0483 | 0.0155 | 0.2691 | 0.0799 |
| nan_inf_detected | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| pitch_max_deg | 6.5098 | 3.3940 | 1.8240 | 13.8442 | 7.4669 |
| pitch_min_deg | -4.8615 | 3.2860 | -14.5494 | -0.0512 | -4.2521 |
| roll_max_deg | 0.7960 | 0.4248 | 0.1722 | 1.6971 | 0.8022 |
| roll_min_deg | -0.2180 | 0.1839 | -0.5823 | 0.0000 | -0.1342 |
...
| pitch_peak_deg | 8.4496 | 2.1293 | 3.7432 | 14.5494 | 7.9876 |
| pitch_rate_rms_deg_s | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| pitch_rms_deg | 3.9108 | 1.0184 | 1.6539 | 6.1881 | 3.9627 |
| pitch_settling_steps | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| roll_peak_deg | 0.8440 | 0.3711 | 0.2541 | 1.6971 | 0.8022 |
| roll_rate_rms_deg_s | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| roll_rms_deg | 0.3708 | 0.2287 | 0.1072 | 1.1086 | 0.3535 |
| yaw_drift_deg | 9.0188 | 8.5126 | 0.8679 | 52.8800 | 6.2859 |
...
| hip_yaw_div_max_rad | 0.1503 | 0.0953 | 0.0263 | 0.5368 | 0.1344 |
| hip_yaw_div_rms_rad | 0.0711 | 0.0498 | 0.0111 | 0.2602 | 0.0532 |
| hip_yaw_joint_max_rad | 0.0861 | 0.0483 | 0.0155 | 0.2691 | 0.0799 |
...
| final_displacement_m | 0.0959 | 0.2181 | 0.0049 | 1.2909 | 0.0528 |
| lateral_drift_m | 0.0003 | 0.2145 | -0.3294 | 1.2530 | -0.0125 |
| max_displacement_m | 0.2081 | 0.2176 | 0.0810 | 1.2909 | 0.1199 |
| sagittal_drift_m | 0.0036 | 0.1036 | -0.5585 | 0.3105 | 0.0101 |
| support_peak_m | 0.2312 | 0.2203 | 0.0937 | 1.3012 | 0.1401 |
| support_rms_m | 0.0860 | 0.0748 | 0.0373 | 0.4590 | 0.0674 |
...
| height_final_m | 0.4010 | 0.0676 | 0.2928 | 0.4904 | 0.4084 |
...
| height_rmse_m | 0.0126 | 0.0222 | 0.0008 | 0.1123 | 0.0052 |
...
| torque_peak_hip_roll_nm | 0.4968 | 0.3534 | 0.1960 | 1.3358 | 0.3535 |
| torque_peak_hip_yaw_nm | 2.1241 | 0.9407 | 0.6552 | 5.1229 | 1.8894 |
...
| torque_peak_legs_nm | 9.3118 | 1.7024 | 8.0000 | 13.7141 | 8.6681 |
...
| torque_peak_total_nm | 9.3900 | 1.6964 | 8.0000 | 13.7141 | 8.6681 |
...
| contact_loss_steps | 2.2821 | 3.0797 | 1.0000 | 11.0000 | 1.0000 |
| long_run_drift_rate_m_per_kstep | 0.0284 | 0.0424 | 0.0024 | 0.2582 | 0.0184 |
| post_pitch_rms_500_deg | 1.3756 | 2.1671 | 0.0000 | 6.3304 | 0.0000 |
...
| stability_score_0_to_1 | 0.7822 | 0.0491 | 0.6802 | 0.8847 | 0.7735 |
...
| hip_yaw_joint_max_rad | 0.2691 | contact_loss_steps | 1 |
| **Posture** | | | |
| pitch_rms_deg | 6.19 | pitch_peak_deg | 10.87 |
| roll_rms_deg | 0.13 | roll_peak_deg | 0.51 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.2691 | hip_yaw_div_rms_rad | 0.2602 |
| **Support/Drift** | | | |
| support_rms_m | 0.2996 | support_peak_m | 0.7650 |
| sagittal_drift_m | -0.559 | lateral_drift_m | -0.329 |
| final_displacement_m | 0.648 | max_displacement_m | 0.759 |
| **Dynamic Height** | | | |
...
| hip_yaw_joint_max_rad | 0.1114 | contact_loss_steps | 1 |
| **Posture** | | | |
| pitch_rms_deg | 3.71 | pitch_peak_deg | 8.47 |
| roll_rms_deg | 0.36 | roll_peak_deg | 0.90 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.1114 | hip_yaw_div_rms_rad | 0.1060 |
| **Support/Drift** | | | |
| support_rms_m | 0.0675 | support_peak_m | 0.1345 |
| sagittal_drift_m | 0.026 | lateral_drift_m | 0.036 |
| final_displacement_m | 0.045 | max_displacement_m | 0.120 |
| **Dynamic Height** | | | |
...
| Safety | | | |
|--------|-----|-----|-----|
| pitch_max_deg | 8.74 | pitch_min_deg | -7.14 |
| roll_max_deg | 0.80 | roll_min_deg | -0.21 |
| hip_yaw_joint_max_rad | 0.1472 | contact_loss_steps | 1 |
| **Posture** | | | |
| pitch_rms_deg | 3.74 | pitch_peak_deg | 8.74 |
| roll_rms_deg | 0.28 | roll_peak_deg | 0.80 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.1472 | hip_yaw_div_rms_rad | 0.1537 |
| **Support/Drift** | | | |
| support_rms_m | 0.0691 | support_peak_m | 0.1533 |
| sagittal_drift_m | 0.017 | lateral_drift_m | -0.055 |
| final_displacement_m | 0.058 | max_displacement_m | 0.144 |
| **Dynamic Height** | | | |
...
| Safety | | | |
|--------|-----|-----|-----|
| pitch_max_deg | 7.96 | pitch_min_deg | -2.39 |
| roll_max_deg | 0.68 | roll_min_deg | -0.05 |
| hip_yaw_joint_max_rad | 0.1150 | contact_loss_steps | 1 |
| **Posture** | | | |
| pitch_rms_deg | 3.72 | pitch_peak_deg | 7.96 |
| roll_rms_deg | 0.33 | roll_peak_deg | 0.68 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.1150 | hip_yaw_div_rms_rad | 0.0764 |
| **Support/Drift** | | | |
| support_rms_m | 0.0651 | support_peak_m | 0.1569 |
| sagittal_drift_m | 0.033 | lateral_drift_m | -0.013 |
| final_displacement_m | 0.035 | max_displacement_m | 0.157 |
| **Torque Quality** | | | |
| torque_peak_total_nm | 8.71 | torque_peak_wheels_nm | 2.96 |
| **Robustness** | | | |
| stability_score | 0.794 | contact_loss_frac | 0.0002 |
| drift_rate_m_per_kstep | 0.0059 | | |
...
| Safety | | | |
|--------|-----|-----|-----|
| pitch_max_deg | 3.74 | pitch_min_deg | -7.48 |
| roll_max_deg | 0.80 | roll_min_deg | -0.08 |
| hip_yaw_joint_max_rad | 0.0489 | contact_loss_steps | 1 |
| **Posture** | | | |
| pitch_rms_deg | 3.52 | pitch_peak_deg | 7.48 |
| roll_rms_deg | 0.29 | roll_peak_deg | 0.80 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.0489 | hip_yaw_div_rms_rad | 0.0291 |
| **Support/Drift** | | | |
| support_rms_m | 0.0636 | support_peak_m | 0.1136 |
| sagittal_drift_m | 0.001 | lateral_drift_m | -0.062 |
| final_displacement_m | 0.062 | max_displacement_m | 0.101 |
| **Torque Quality** | | | |
| torque_peak_total_nm | 8.78 | torque_peak_wheels_nm | 2.04 |
| **Robustness** | | | |
| stability_score | 0.806 | contact_loss_frac | 0.0005 |
| drift_rate_m_per_kstep | 0.0308 | | |
...
| roll_max_deg | 0.96 | roll_min_deg | -0.19 |
| hip_yaw_joint_max_rad | 0.0776 | contact_loss_steps | 1 |
| **Posture** | | | |
| pitch_rms_deg | 4.43 | pitch_peak_deg | 11.64 |
| roll_rms_deg | 0.40 | roll_peak_deg | 0.96 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.0776 | hip_yaw_div_rms_rad | 0.0532 |
| **Support/Drift** | | | |
| support_rms_m | 0.0630 | support_peak_m | 0.1682 |
| sagittal_drift_m | 0.004 | lateral_drift_m | -0.024 |
| final_displacement_m | 0.024 | max_displacement_m | 0.151 |
| **Torque Quality** | | | |
| torque_peak_total_nm | 8.81 | torque_peak_wheels_nm | 6.68 |
| **Robustness** | | | |
| stability_score | 0.754 | contact_loss_frac | 0.0005 |
| drift_rate_m_per_kstep | 0.0120 | | |
...
| hip_yaw_joint_max_rad | 0.1690 | contact_loss_steps | 4 |
| **Posture** | | | |
| pitch_rms_deg | 4.40 | pitch_peak_deg | 9.90 |
| roll_rms_deg | 0.55 | roll_peak_deg | 1.04 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.1690 | hip_yaw_div_rms_rad | 0.1002 |
| **Support/Drift** | | | |
...
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.0525 | hip_yaw_div_rms_rad | 0.0386 |
| **Support/Drift** | | | |
| support_rms_m | 0.0500 | support_peak_m | 0.1401 |
| sagittal_drift_m | 0.011 | lateral_drift_m | -0.085 |
| final_displacement_m | 0.086 | max_displacement_m | 0.103 |
| **Torque Quality** | | | |
| torque_peak_total_nm | 8.71 | torque_peak_wheels_nm | 2.96 |
| **Robustness** | | | |
| stability_score | 0.822 | contact_loss_frac | 0.0005 |
| drift_rate_m_per_kstep | 0.0429 | | |
...
| Safety | | | |
|--------|-----|-----|-----|
| pitch_max_deg | 9.03 | pitch_min_deg | -0.39 |
| roll_max_deg | 0.80 | roll_min_deg | -0.11 |
| hip_yaw_joint_max_rad | 0.0408 | contact_loss_steps | 1 |
| **Posture** | | | |
| pitch_rms_deg | 5.24 | pitch_peak_deg | 9.03 |
| roll_rms_deg | 0.32 | roll_peak_deg | 0.80 |
| **Leg Symmetry** | | | |
| hip_yaw_joint_max_rad | 0.0408 | hip_yaw_div_rms_rad | 0.0211 |
| **Support/Drift** | | | |
| support_rms_m | 0.0674 | support_peak_m | 0.1166 |
| sagittal_drift_m | 0.002 | lateral_drift_m | -0.012 |
| final_displacement_m | 0.012 | max_displacement_m | 0.087 |
| **Torque Quality** | | | |
| torque_peak_total_nm | 9.16 | torque_peak_wheels_nm | 3.13 |
| **Robustness** | | | |
| stability_score | 0.719 | contact_loss_frac | 0.0005 |
| drift_rate_m_per_kstep | 0.0060 | | |
...
Full metrics exported to: `docs\validation\k2_default_v1_quality.json`