...
- B2v2 improve heights (vs B by score): 6/10 (need >=6 for full pass, >=0 for partial)
- B2v2 regression heights (vs B by score): 2/10 (>2 fails)
...
- **Partial pass: no regression vs B. Eligible for Step C/D if n_regress <= 2.**
