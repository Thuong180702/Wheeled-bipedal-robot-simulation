...
**Generated:** 2026-06-30T12:15:54.480421
**Input:** `outputs\k2_candidate_e2_full`
**input_dir:** outputs\k2_candidate_e2_full
...
- **Performance:** 189.2 Hz avg (min 118.5, max 198.2)
...
Full metrics exported to: `docs\validation\k2_candidate_e2_quality.json`