"""Phase 9D: Support-Centered Height Ladder Analysis — compare with phase-aware baseline.

Reads support_centering_bias_trim telemetry from t6j_height_ladder_2000_<label>/
telemetry_2000.csv, computes drift and stability metrics, and compares with the
phase-aware authority release baseline data.
"""
import csv
import json
import math
