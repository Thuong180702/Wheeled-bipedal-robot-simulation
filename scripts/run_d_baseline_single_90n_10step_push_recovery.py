# scripts/run_d_baseline_single_90n_10step_push_recovery.py
"""D baseline single-push recovery diagnostic.

Runs the exact same single-push scenario as G1_sg080 but with D baseline
...
Usage:
    python scripts/run_d_baseline_single_90n_10step_push_recovery.py
"""
...
OUT_DIR = (
    ROOT
    / "outputs"
    / "d_baseline_single_90n_10step_push_recovery_2000"
)

CASE_ID = "D_baseline_single_90n_10step_push_high_2000"
...
def main():
    print("=" * 80)
    print("D Baseline Single-Push Recovery Diagnostic (90 N, 10 steps, 2000 steps)")
    print("=" * 80)
