...
warnings.warn(
    "scripts/analyze_t6j_height_ladder.py is deprecated. "
    "Use: python scripts/analyze_support_centering_height_ladder.py",
    DeprecationWarning,
    stacklevel=2,
)

sys.path.insert(0, str(Path(__file__).resolve().parents[1]))
import analyze_support_centering_height_ladder as new_module
