'''G1_sg080 single-push recovery diagnostic (step300, 3000 steps).

Runs a single sagittal push (90 N, 10 steps) at step 300 on the high_0p480 height variant for the G1_sg080 controller profile, then simulates 3000 steps total to observe recovery and stabilization.

This is a diagnostic run only. G1_sg080 is not promoted by this task.
D (D_MODE_HIP_YAW_DIV_V1) remains current-best.

Usage:
    python scripts/run_g1_sg080_single_90n_10step_push_step300_3000.py
'''
...
PUSH_COUNT = 1
PUSH_START_STEP = 300
TIMEOUT_S = 1200  # allow longer for 3000 steps
...
def main():
    print("=" * 80)
    print("G1_sg080 Single-Push Recovery Diagnostic (90 N, 10 steps, step 300, 3000 steps)")
    print("=" * 80)
