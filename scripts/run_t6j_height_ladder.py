"""T6J Height Ladder Runner — Phase 9B/9C.

Runs T6J_centering_bias_trim across all available height variant setups,
saving telemetry and summaries to per-variant output directories.
