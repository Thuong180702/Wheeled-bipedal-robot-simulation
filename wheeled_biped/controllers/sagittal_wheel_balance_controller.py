...
class SagittalWheelBalanceController:
    ...
    def compute(
        ...
        Args:
            ...
            outer_position_bias: Unused, kept for interface compatibility
            position_y_m: Unused, kept for interface compatibility
            roll_y_rad: Unused, kept for interface compatibility
