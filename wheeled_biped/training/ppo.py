...
class PPOTrainer:
    ...
    def __init__(
        ...
        self.value_coeff = ppo_cfg.get("value_loss_coeff", 1.0)
    ...
    def eval_pass(
        ...
        if (
            ...
            # obs[-3] = height_norm, obs[-2] = current_height_norm, obs[-1] = yaw_error.
            # Patch height_norm at index -3; current_height_norm and yaw_error come from reset().
            new_obs = env_state.obs.at[:, -3].set(height_norm)
            new_info = {
                **env_state.info,
    ...
    def train(
        ...
        if "eval_interval_steps" in curriculum_cfg:
            target_steps = int(curriculum_cfg["eval_interval_steps"])
