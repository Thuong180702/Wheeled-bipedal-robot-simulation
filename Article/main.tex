...
Domain randomization~\cite{tobin2017domain} is applied during training to improve robustness: body masses are perturbed by $\pm 10\%$ and ground friction coefficients by $\pm 20\%$ relative to their nominal values.
